...
namespace paint
{
    ...
    {
        List<Figure> array; // список объектов типа Figure.
        public BufferedGraphics buffer; //  буферизованная графика для рисования на форме.
        public BufferedGraphicsContext contex; // контекст буферизованной графики.
